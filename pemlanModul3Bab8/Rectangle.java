...
public class Rectangle implements Colorable, Comparable {
    ...
    public void compareTo(Object obj) {
        ...
        if (this.kategori == 0) {
            System.out.println(
                    "ukuran cat yang cocok untuk bangun kotak dengan kategori " + this.kategori + " yaitu 2.5L");
        } else {
            System.out.println(
                    "ukuran cat yang cocok untuk bangun kotak dengan kategori " + this.kategori + " yaitu 6.5L");
        }
    }
